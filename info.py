...
# File Limit Settings
# ============================
IS_FILE_LIMIT = is_enabled(environ.get('IS_FILE_LIMIT', "False"), False)  # Enable Or Disable Free File Limit
FILES_LIMIT = int(environ.get("FREE_FILES", "1"))  # No. of Files A Free User Gets Before Premium Is Required

# ============================
# Advertisement Settings
# ============================
ADS_MODE = is_enabled(environ.get('ADS_MODE', "False"), False)  # Show sponsored ad button with files (True) / Off (False)
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', LOG_CHANNEL)) # Logs of shortener/fsub changes done inside groups
